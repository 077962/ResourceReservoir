...
<div class="addNewLinkOnIndex">
	<?php 
		echo $this->Form->postLink(__('Delete Project'), array('action' => 'delete', $this->Form->value('Project.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Project.id')));		
		echo '&nbsp; &nbsp; &nbsp;';
