<div class="ratings index">
	...
	<div class="addNewLinkOnIndex"><?php echo $this->Html->link(__('New Rating'), array('action' => 'add')); ?></div>
	<table cellpadding="0" cellspacing="0">
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('rating'); ?></th>
			<th><?php echo $this->Paginator->sort('rating_cycle'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($rating['Rating']['rating_cycle']); ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		...
		<li class="currentAction"><?php echo $this->Html->link(__('List Ratings'), array('controller' => 'ratings', 'action' => 'index')); ?> </li>		
