<div class="roles index">
	...
	<div class="addNewLinkOnIndex"><?php echo $this->Html->link(__('New Role'), array('action' => 'add')); ?></div>
	...
	<tr>
		...
		<td><?php echo h($role['Role']['short_form']); ?>&nbsp;</td>
		<td><?php echo h($role['Role']['is_active']); ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>
		...
		<li class="currentAction"><?php echo $this->Html->link(__('List Roles'), array('controller' => 'roles', 'action' => 'index')); ?> </li>		
