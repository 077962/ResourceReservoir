<div class="userinfos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('extra_comments'); ?></th>
	...
	<tr>
		<td><?php echo h($userinfo['Userinfo']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($userinfo['Userinfo']['created']); ?>&nbsp;</td>
		<td><?php echo h($userinfo['Userinfo']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $userinfo['Userinfo']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $userinfo['Userinfo']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userinfo['Userinfo']['id']), null, __('Are you sure you want to delete # %s?', $userinfo['Userinfo']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		...
		<li class="currentAction"><?php echo $this->Html->link(__('List User Info'), array('controller' => 'userinfos', 'action' => 'index')); ?> </li>		
