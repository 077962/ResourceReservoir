<div class="users index">
	...
	<div class="addNewLinkOnIndex"><?php echo $this->Html->link(__('New User'), array('action' => 'add')); ?></div>
	...
	<tr>
		...
		<td><?php echo h($user['User']['manager_id']); ?>&nbsp;</td>
...
<div class="actions">
	...
	<ul>		
		<li class="currentAction"><?php echo $this->Html->link(__('List Users'), array('controller' => 'users', 'action' => 'index')); ?> </li>
