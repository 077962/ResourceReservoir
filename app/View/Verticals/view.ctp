...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Vertical'), array('action' => 'edit', $vertical['Vertical']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Vertical'), array('action' => 'delete', $vertical['Vertical']['id']), null, __('Are you sure you want to delete # %s?', $vertical['Vertical']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Verticals'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Vertical'), array('action' => 'add')); ?> </li>
